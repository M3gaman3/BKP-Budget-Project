local Translations = {
    ...
    info = {
        ...
        els_hospital = 'East Los Santos Hospital',
        sd_hospital = 'Sandy Shores Hospital',
        pt_hospital = 'Paleto Hospital',
        cp_hospital = 'Cayo Perico Hospital',
        ps_hospital = 'Paleto Secret Hospital',
        cs_hospital = 'Cayo Perico Secret Hospital',
