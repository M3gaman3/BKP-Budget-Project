...
Config.K9Kennel = {									-- Location of where police can pull out a K9
	vector3(437.24, -977.92, 30.9), ---city
	vector3(371.46, -1612.83, 29.29), ---davis
	vector3(1854.69, 3700.57, 34.39), ---sandy									
	vector3(-442.5, 5992.2, 31.48), ---paleto
	vector3(1732.44, 3029.22, 62.64), ---park ranger
	vector3(1762.25, 2468.47, 46.09), ---prison
	vector3(5139.91, -4704.95, 2.21), ---cayo perico
}
Config.DogMaxHp = 200								-- Sets Dog's max hp (MAX IS 200)
Config.LEOJobName = {'police', 'lspd', 'sasp', 'bcso', 'sapr', 'mp'} -- Name of police job that can pull out K9
